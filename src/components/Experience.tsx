export function Experience() {
  return (
    <section id="experience" className="max-w-[1440px] mx-auto px-6 md:px-20 mb-[120px] pt-32 relative">
        ...
        <div className="space-y-16 md:space-y-24">
          ...
          <div className="relative flex flex-col md:flex-row items-center w-full group">
            ...
            <div className="w-full md:w-1/2 pl-12 md:pl-16">
              <div className="glass-panel rounded-2xl p-6 md:p-8 transition-all duration-300 bg-surface-bright/30 border border-white/20 hover:shadow-[0_0_30px_rgba(173,198,255,0.25)] hover:border-white/30">
